...
COMMIT_URL_BASE="https://github.com/whatwg/mimesniff/commit/"
BRANCH_URL_BASE="https://github.com/whatwg/mimesniff/tree/"

INPUT_FILE="mimesniff.bs"
SERVER="mimesniff.spec.whatwg.org"
WEB_ROOT="mimesniff.spec.whatwg.org"
